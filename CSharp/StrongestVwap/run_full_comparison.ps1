...
$baseOutput = "D:\C#_backtest\modeE_full_v2"

$configs = @(
    @{ Name="eq_no_filter_lu";   Config="configs/mode_e_B_tl_always_eq.yaml" },
    @{ Name="eq_filter_lu";      Config="configs/mode_e_B_tl_always_eq_filter_lu.yaml" }
)
...
Write-Host ""
Write-Host "============================================================"
Write-Host "Full comparison completed!"
Write-Host "Results:"
Write-Host "  No filter LU:  $baseOutput\eq_no_filter_lu"
Write-Host "  Filter LU:     $baseOutput\eq_filter_lu"
Write-Host "============================================================"
