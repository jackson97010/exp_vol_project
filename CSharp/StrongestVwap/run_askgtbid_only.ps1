...
$outputPath = "D:\C#_backtest\modeE_askgtbid_full\ask_gt_bid"

Write-Host ""
Write-Host "============================================================"
Write-Host "Running: ask_gt_bid (full year)"
Write-Host "Config:  configs/mode_e_B_tl_always_eq_filter_lu_askgtbid.yaml"
Write-Host "Output:  $outputPath"
Write-Host "Dates:   $($dates.Count)"
Write-Host "============================================================"

$cmd = "dotnet run -- --mode batch --dates $dateArgs --config `"configs/mode_e_B_tl_always_eq_filter_lu_askgtbid.yaml`" --screening_csv `"$screeningCsv`" --tick_data `"$tickData`" --output_path `"$outputPath`""
Invoke-Expression $cmd

Write-Host ""
Write-Host "============================================================"
Write-Host "Done! Results: $outputPath"
Write-Host "============================================================"
