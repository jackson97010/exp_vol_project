...
$configs = @(
    @{ Name="B_tp080_top5_baseline";   Config="configs/mode_e_B.yaml" },
    @{ Name="B_tp080_top5_tl_always";  Config="configs/mode_e_B_tl_always.yaml" },
    @{ Name="B_tp080_top5_tl_after_tp"; Config="configs/mode_e_B_tl_after_tp.yaml" }
)
...
Write-Host ""
Write-Host "============================================================"
Write-Host "Trailing low grid completed!"
Write-Host "Results:"
Write-Host "  Baseline:    $baseOutput\B_tp080_top5_baseline"
Write-Host "  TL always:   $baseOutput\B_tp080_top5_tl_always"
Write-Host "  TL after TP: $baseOutput\B_tp080_top5_tl_after_tp"
Write-Host "============================================================"
