...
$baseOutput = "D:\C#_backtest\modeE_full"

$configs = @(
    @{ Name="tl_always_2020_2040";  Config="configs/mode_e_B_tl_always.yaml" },
    @{ Name="tl_always_eq_25252525"; Config="configs/mode_e_B_tl_always_eq.yaml" }
)
...
Write-Host ""
Write-Host "============================================================"
Write-Host "Full range backtest completed!"
Write-Host "Results:"
Write-Host "  20/20/20/40: $baseOutput\tl_always_2020_2040"
Write-Host "  25/25/25/25: $baseOutput\tl_always_eq_25252525"
Write-Host "============================================================"
