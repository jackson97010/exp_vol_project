$dates = @(
    ...
    "2025-02-24","2025-02-25","2025-02-26","2025-02-27","2025-03-03",
    ...
    "2025-04-02","2025-04-09","2025-04-11","2025-04-14","2025-04-15",
    ...
    "2025-05-29","2025-06-02","2025-06-03","2025-06-04","2025-06-05",
    ...
    "2025-09-19","2025-09-22","2025-09-23","2025-09-24","2025-09-25",
    "2025-09-26","2025-09-30","2025-10-01","2025-10-02","2025-10-03",
    "2025-10-07","2025-10-08","2025-10-09","2025-10-13","2025-10-14",
    ...
    "2025-11-13","2025-11-14","2025-11-17","2025-11-18","2025-11-20",
    "2025-11-21","2025-11-24","2025-11-25","2025-11-26","2025-11-27",
    ...
    "2025-12-19","2025-12-22","2025-12-23","2025-12-24","2025-12-26",
...
$baseOutput = "D:\C#_backtest\LimitUp_NextDay_Full"

# 3 configs: bypass group screening, extended entry at 0906/0907/0908
$configs = @(
    @{ Name="C1_bypass_extended_0906"; Config="configs/C1_bypass_extended_0906.yaml" },
    @{ Name="C1_bypass_extended_0907"; Config="configs/C1_bypass_extended_0907.yaml" },
    @{ Name="C1_bypass_extended_0908"; Config="configs/C1_bypass_extended_0908.yaml" }
)
...
Write-Host ""
Write-Host "============================================================"
Write-Host "All 3 entry time configs completed!"
Write-Host "Results (LimitUp NextDay, entry time comparison):"
Write-Host "  C1 0906: $baseOutput\C1_bypass_extended_0906"
Write-Host "  C1 0907: $baseOutput\C1_bypass_extended_0907"
Write-Host "  C1 0908: $baseOutput\C1_bypass_extended_0908"
Write-Host "(Previously completed: C1_0905 and C2_0909)"
Write-Host "============================================================"
