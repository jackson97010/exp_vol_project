...
$screeningCsv = "D:\C#_backtest\screen_hot_category.csv"
$tickData = "D:\feature_data\feature"
$baseOutput = "D:\C#_backtest\ModeE_vwap5m_compare"

# 8 configs: 4 original (vwap) + 4 vwap_5m
$configs = @(
    @{ Name="A1_extended_filter_lu";          Config="configs/A1_extended_filter_lu.yaml" },
    @{ Name="A1_extended_filter_lu_v5m";      Config="configs/A1_extended_filter_lu_v5m.yaml" },
    @{ Name="A2_extended_no_filter_lu";       Config="configs/A2_extended_no_filter_lu.yaml" },
    @{ Name="A2_extended_no_filter_lu_v5m";   Config="configs/A2_extended_no_filter_lu_v5m.yaml" },
    @{ Name="B1_massive_filter_lu";           Config="configs/B1_massive_filter_lu.yaml" },
    @{ Name="B1_massive_filter_lu_v5m";       Config="configs/B1_massive_filter_lu_v5m.yaml" },
    @{ Name="B2_massive_no_filter_lu";        Config="configs/B2_massive_no_filter_lu.yaml" },
    @{ Name="B2_massive_no_filter_lu_v5m";    Config="configs/B2_massive_no_filter_lu_v5m.yaml" }
)
...
Write-Host ""
Write-Host "============================================================"
Write-Host "All 8 configs completed!"
Write-Host "Results (VWAP vs VWAP_5m):"
Write-Host "  A1 vwap:    $baseOutput\A1_extended_filter_lu"
Write-Host "  A1 vwap5m:  $baseOutput\A1_extended_filter_lu_v5m"
Write-Host "  A2 vwap:    $baseOutput\A2_extended_no_filter_lu"
Write-Host "  A2 vwap5m:  $baseOutput\A2_extended_no_filter_lu_v5m"
Write-Host "  B1 vwap:    $baseOutput\B1_massive_filter_lu"
Write-Host "  B1 vwap5m:  $baseOutput\B1_massive_filter_lu_v5m"
Write-Host "  B2 vwap:    $baseOutput\B2_massive_no_filter_lu"
Write-Host "  B2 vwap5m:  $baseOutput\B2_massive_no_filter_lu_v5m"
Write-Host "============================================================"
