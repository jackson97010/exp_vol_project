# B2_massive_no_filter_lu with bypass_group (no group screening, use screening CSV stock list)
...
$outputPath = "D:\C#_backtest\ModeE_full_compare\B2_bypass_group"
$config = "configs/B2_massive_no_filter_lu.yaml"

Write-Host ""
Write-Host "============================================================"
Write-Host "Running: B2_massive_no_filter_lu (bypass group screening)"
Write-Host "Config:  $config"
Write-Host "Output:  $outputPath"
Write-Host "Dates:   $($dates.Count)"
Write-Host "============================================================"

$cmd = "dotnet run --configuration Release -- --mode batch --dates $dateArgs --config `"$config`" --screening_csv `"$screeningCsv`" --tick_data `"$tickData`" --output_path `"$outputPath`" --bypass_group"
Invoke-Expression $cmd

Write-Host ""
Write-Host "============================================================"
Write-Host "Bypass group backtest complete!"
Write-Host "Output: $outputPath"
Write-Host "============================================================"
