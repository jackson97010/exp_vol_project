...
$baseOutput = "D:\C#_backtest\ModeE_entry_times"

# 12 configs: 3 entry times (0906/0907/0908) x 2 filter modes x 2 rank modes
$configs = @(
    # 0906
    @{ Name="A1_0906_filter_lu";          Config="configs/A1_0906_filter_lu.yaml" },
    @{ Name="A1_0906_filter_lu_v5m";      Config="configs/A1_0906_filter_lu_v5m.yaml" },
    @{ Name="A2_0906_no_filter_lu";       Config="configs/A2_0906_no_filter_lu.yaml" },
    @{ Name="A2_0906_no_filter_lu_v5m";   Config="configs/A2_0906_no_filter_lu_v5m.yaml" },
    # 0907
    @{ Name="A1_0907_filter_lu";          Config="configs/A1_0907_filter_lu.yaml" },
    @{ Name="A1_0907_filter_lu_v5m";      Config="configs/A1_0907_filter_lu_v5m.yaml" },
    @{ Name="A2_0907_no_filter_lu";       Config="configs/A2_0907_no_filter_lu.yaml" },
    @{ Name="A2_0907_no_filter_lu_v5m";   Config="configs/A2_0907_no_filter_lu_v5m.yaml" },
    # 0908
    @{ Name="A1_0908_filter_lu";          Config="configs/A1_0908_filter_lu.yaml" },
    @{ Name="A1_0908_filter_lu_v5m";      Config="configs/A1_0908_filter_lu_v5m.yaml" },
    @{ Name="A2_0908_no_filter_lu";       Config="configs/A2_0908_no_filter_lu.yaml" },
    @{ Name="A2_0908_no_filter_lu_v5m";   Config="configs/A2_0908_no_filter_lu_v5m.yaml" }
)
...
Write-Host ""
Write-Host "============================================================"
Write-Host "All 12 configs completed!"
Write-Host "Results (entry time comparison, 0906/0907/0908):"
foreach ($c in $configs) {
    Write-Host "  $($c.Name): $baseOutput\$($c.Name)"
}
Write-Host "============================================================"
