#!/bin/bash
# run_ma5_bias7.sh
# MA5 bias threshold backtest (bias7 = MA5*1.07): screening_results.csv x 263 dates
# Config: Bo_v2_modeC_screening.yaml + --ma5_bias7 flag
# Output: D:\C#_backtest\MA5_bias7

PROJECT_DIR="D:/03_預估量相關資量/CSharp/BacktestModule"
OUTPUT_PATH="D:/C#_backtest/MA5_bias7"
...
echo "============================================"
echo "MA5 Bias7 Threshold Backtest"
echo "Config: Bo_v2_modeC_screening.yaml + --ma5_bias7"
