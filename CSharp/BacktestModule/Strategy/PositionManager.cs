...
namespace BacktestModule.Strategy
{
    ...
    public class Position
    {
        ...
        public double EntryOutsideVolume5s { get; set; }
        ...
        public Dictionary<string, bool> ExitLevelsTriggered { get; set; } = new()
        {
            ...
            ["mode_d_stage2"] = false,
            ["mode_d_stage3"] = false,
            ["mode_e_target1"] = false,
            ["mode_e_target2"] = false,
            ["mode_e_target3"] = false
        };
        ...
        public Position(
            ...
            double entryOutsideVolume5s = 0.0)
        {
            EntryTime = entryTime;
            ...
            EntryOutsideVolume5s = entryOutsideVolume5s;
    ...
    public class TradeRecord
    {
        ...
        // Split entry fields (Lot A / Lot B grouping)
        public int? GroupId { get; set; }
        public string LotType { get; set; } = "A";
    ...
    public class PositionManager
    {
            ...
            double entryOutsideVolume5s = 0.0)
        {
            CurrentPosition = new Position(
                ...
                dayHighAtEntry, entryRatio, entryOutsideVolume3s, entryOutsideVolume5s);
