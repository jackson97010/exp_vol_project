# Run ModeC backtest on screen_limit_up_open_entry.csv

$ErrorActionPreference = "Continue"
Set-Location "$PSScriptRoot/.."
$configFile = "configs/Bo_v2_modeC_limit_up_open_entry.yaml"
...
Write-Host "Output: D:\C#_backtest\limit_up_open_entry"
Write-Host "Config: $configFile (ModeC)"
Write-Host "CSV: $csvPath (365 rows)"
Write-Host "========================================"
