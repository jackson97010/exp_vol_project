# Run ModeC backtest on screen_limit_up_entry.csv

$ErrorActionPreference = "Continue"
Set-Location "$PSScriptRoot/.."
$configFile = "configs/Bo_v2_modeC_limit_up_entry.yaml"
$csvPath = "screen_limit_up_entry.csv"
...
Write-Host "Output: D:\C#_backtest\limit_up_entry"
Write-Host "Config: $configFile (ModeC)"
Write-Host "CSV: $csvPath (1188 rows)"
Write-Host "========================================"
